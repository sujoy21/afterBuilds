    ...
    return (
        <View style={{ backgroundColor: "white", flex: 1, }}>
            ...
            <View style={{ borderBottomColor: 'black', borderBottomWidth: 1, width: widthToDp('90%'), marginLeft: widthToDp('5%'), marginRight: widthToDp('5%') }}>
                <Text style={{ color: 'black', fontWeight: '500', fontSize: widthToDp('6%'), textAlign: 'center', marginTop: heightToDp('2%'), marginBottom: heightToDp('2%') }}>Feedback</Text>
            </View>
            <View style={{ height: heightToDp('40%'), width: widthToDp('90%'), marginTop: heightToDp('4%'), alignSelf: 'center', backgroundColor: 'white' }}>
                ...
                <TouchableOpacity
                    style={{ backgroundColor: 'white', height: heightToDp('4%'), width: widthToDp('25%'), marginTop: heightToDp('2%'), alignSelf: 'flex-start', borderRadius: 10, justifyContent: 'center', elevation: 10 }}
                >
                    <Text style={{ color: 'black', fontWeight: 'bold', fontSize: widthToDp('4%'), textAlign: 'center' }}>Rate your Order</Text>
                </TouchableOpacity>
            </View>
            <View style={{ height: heightToDp('40%'), width: widthToDp('90%'), marginTop: heightToDp('4%'), alignSelf: 'center', backgroundColor: 'white' }}>
                <View style={{ flexDirection: 'row', height: heightToDp('4%'), width: widthToDp('25%'), justifyContent: 'space-around', alignItems: 'center' }}>
